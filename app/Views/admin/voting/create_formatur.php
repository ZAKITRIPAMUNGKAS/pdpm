        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= site_url('admin-voting/store') ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                            ...
                            <div class="col-md-8">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="required_selections" name="required_selections" 
                                                   value="<?= old('required_selections', 9) ?>" min="1" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="min_candidates" name="min_candidates" 
                                                   value="<?= old('min_candidates', 9) ?>" min="1" required>
                                ...
                                <div class="form-group">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="show_results_before_end" name="show_results_before_end" value="1" <?= old('show_results_before_end') ? 'checked' : '' ?> style="pointer-events: auto; z-index: 1;">
                        ...
                        <div id="candidates-container">
                            ...
                            $defaultCount = max(9, count($oldOptions));
                        ...
                        <div class="form-group d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save"></i> Simpan Voting Formatur
                            </button>
                        </div>
                    </form>
                </div>
